...
MODEL_PATH = "face_landmarker.task"  # update path if needed
...
DEAD_ZONE         = 0.15
PORT              = int(os.environ.get("PORT", 5000))  # Vercel injects PORT automatically

# ── State ──────────────────────────────────────────────────────────
# NOTE: On Vercel serverless, global state resets between cold starts.
# Fine for testing. For production, move state to the frontend or a database.
lock = threading.Lock()
blink_start       = None
...
# ── Start ──────────────────────────────────────────────────────────
# No ngrok needed — Vercel provides the public URL automatically.
# Vercel also injects the PORT environment variable automatically.
